...
<div align="center">
  ...
  <img
    width="100%"
    src="https://capsule-render.vercel.app/api?type=waving&color=0:7F00FF,100:00C9FF&height=210&section=header&text=Emre%20Üçbudak&fontSize=45&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=Software%20Engineering%20Student%20%7C%20Full%20Stack%20Developer&descAlignY=58&descSize=18"
    alt="Emre Üçbudak"
  />
...
Modern yazılım mimarileri, performanslı sistemler ve ölçeklenebilir çözümler üzerine çalışan bir  
<strong>Software Engineering öğrencisi ve Full Stack Developer</strong>'ım.

Backend geliştirme, veritabanı tasarımı, dağıtık sistemler ve modern kullanıcı arayüzleriyle ilgileniyorum.  
Öğrenmeyi, üretmeyi ve geliştirdiğim projeleri her geçen gün daha ileri taşımayı seviyorum.
...
<!-- İlgi alanları -->
<h2 align="center">🎯 Odaklandığım Alanlar</h2>

<div align="center">

`Backend Development` • `RESTful APIs` • `Clean Architecture`  
`Microservices` • `Database Design` • `Caching`  
`Message Queues` • `Containerization` • `Mobile Development`
...
<div align="center">
  ...
  <img
    width="70%"
    src="https://streak-stats.demolab.com?user=emreucbudak&theme=tokyonight&hide_border=true&background=0D1117"
    alt="GitHub streak"
  />
...
<div align="center">
  ...
  <img
    width="90%"
    src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=emreucbudak&theme=tokyonight"
...
<div align="center">
  ...
  <a href="mailto:emreucbudak87@gmail.com">
    <img
...
<div align="center">
  ...
  <img
    src="https://raw.githubusercontent.com/emreucbudak/emreucbudak/output/snake.svg"
